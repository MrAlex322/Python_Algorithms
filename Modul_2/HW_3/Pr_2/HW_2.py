...
# В магазине действуют специальные скидки на товары. Если вы купите i-й товар, то получите скидку, эквивалентную
# ценам[j], где j — минимальный индекс, такой что j > i и цены[j] <= цены[i]. В противном случае вы не получите
# никакой скидки вообще.

#Скорость работы  O(n^2), где n - размер списка self.price.
